...
Following what we learnt in the previous chapter, we can guess here that implicitHeight of a Column is the sum of the implicitHeight of all its children + the spacings; and the implicitWidth of a Column is the max implicitWidth of its children.
