...
### Qt Quick
QML is a *user interface markup language* developped by Qt. It is made to develop user interface very quickly, it is highly customizable and can run virtualy anywhere, from desktop, to mobile and embeded. Qt Quick is the framework and the library build around the creation of application with QML. It it also very fast, but as it is a new language, it is sometimes quite hard to grasp and can be unpredictable.

## What this course cover
Add a section explaining what this course will focus and what it will not.
...
## Structure
Add a section to detail how the course is structured, how the pieces of codes are organized, how to run them, where to find the sample projects, etc...

## Credit
Add what we used as a reference to create this book?
